import 'package:test_core/src/util/errors.dart';
...
/* jemon jodi keo vul a negative number use kore deposit er somoy
   tahole ei 'exception' use kora jai */
  print("Case-5");
  // custom exception
  try{
    depositMoney(-200);
...
class DepositException implements Exception {
  String errormessage() => "You cannot enter amount less than 0 or negative number" ;
}
